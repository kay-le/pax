...
python -m pax.experiment +experiment/$EXPERIMENT seed=21 ++num_iters=20 ++popsize=40 ++num_outer_steps=20 ++num_inner_steps=80 ++num_devices=1 hydra.run.dir=$TMPDIR/hydra_output
