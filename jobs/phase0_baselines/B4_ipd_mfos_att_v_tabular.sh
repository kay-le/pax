#!/bin/bash
# Unified launcher for B4 IPD mfos_att vs tabular
#
# Usage:
#   bash B4_ipd_mfos_att_v_tabular.sh <platform> <seed>
#
# Platforms:
...
#
# Examples:
#   bash B4_ipd_mfos_att_v_tabular.sh fir 0
#   bash B4_ipd_mfos_att_v_tabular.sh tri 0
#   bash B4_ipd_mfos_att_v_tabular.sh tri-debug 0
...
EXPERIMENT="ipd=mfos_att_v_tabular"
RESUME_DIR="/scratch/lichenqi/resume/B4_ipd_seed${SEED}"
