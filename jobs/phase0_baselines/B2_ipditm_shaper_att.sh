...
#
# Usage:
#   bash B2_ipditm_welfare_shaper_att.sh <platform> <seed>
#
# Platforms:
...
#
# Examples:
#   bash B2_ipditm_welfare_shaper_att.sh fir 21
#   bash B2_ipditm_welfare_shaper_att.sh tri 0
#   bash B2_ipditm_welfare_shaper_att.sh tri-debug 21
...
EXPERIMENT="ipditm=train_shaper_att"
RESUME_DIR="/scratch/lichenqi/resume/B2_ipditm_seed${SEED}"
