...
#
# Usage:
#   bash B5_ipditm_welfare_shaper_att.sh <platform> <seed>
#
# Platforms:
...
#
# Examples:
#   bash B5_ipditm_welfare_shaper_att.sh fir 21
#   bash B5_ipditm_welfare_shaper_att.sh tri 0
#   bash B5_ipditm_welfare_shaper_att.sh tri-debug 21
...
RESUME_DIR="/scratch/lichenqi/resume/B5_ipditm_seed${SEED}"
