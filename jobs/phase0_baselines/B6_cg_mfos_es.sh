#!/bin/bash
# Unified launcher for B6 CG MFOS (ES) vs PPO_memory
#
# Usage:
#   bash B6_cg_mfos_es.sh <platform> <seed>
#
# Platforms:
#   fir        — Fir cluster, 4×H100
#   tri        — Trillium cluster, 4×H100
#   tri-debug  — Trillium, 1×H100, 1h, small params, runs twice to test resume
#
# Examples:
#   bash B6_cg_mfos_es.sh fir 0
#   bash B6_cg_mfos_es.sh tri 0
#   bash B6_cg_mfos_es.sh tri-debug 0
...
EXPERIMENT="cg=train_mfos_es"
RESUME_DIR="/scratch/lichenqi/resume/B6_cg_seed${SEED}"
