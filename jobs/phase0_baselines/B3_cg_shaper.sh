#!/bin/bash
# Unified launcher for B3 CG shaper (EARL) vs PPO_memory
#
# Usage:
#   bash B3_cg_shaper.sh <platform> <seed>
#
# Platforms:
...
#
# Examples:
#   bash B3_cg_shaper.sh fir 0
#   bash B3_cg_shaper.sh tri 0
#   bash B3_cg_shaper.sh tri-debug 0
...
EXPERIMENT="cg=train_shaper"
RESUME_DIR="/scratch/lichenqi/resume/B3_cg_seed${SEED}"
